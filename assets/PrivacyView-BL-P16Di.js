import{r as p,o as v,e as k,f as l,g as s,h as t,i as C,j as f,F as u,s as _,m,k as y,q as w,t as h}from"./index-IaK2R5-W.js";const T={class:"privacy-page"},B={class:"page-header"},V={class:"container"},b=t("h1",null,"隱私政策",-1),I={class:"breadcrumb"},M=t("span",{class:"separator"},"/",-1),N=t("span",{class:"current"},"隱私政策",-1),S={class:"privacy-content"},$={class:"container"},x={class:"content-wrapper"},H={class:"privacy-nav"},L={class:"nav-container"},O=t("h3",null,"目錄",-1),A=["href","onClick"],F={class:"privacy-text"},P=t("div",{class:"intro-text"},[t("p",null," SHIBA飯店（以下簡稱「我們」）非常重視您的隱私。本隱私政策旨在說明我們如何收集、使用、披露和保護您的個人資料。請您在使用我們的服務前，詳細閱讀本隱私政策。 "),t("p",null," 本隱私政策適用於我們的網站、行動應用程式、實體飯店及所有相關服務。當您使用我們的服務時，即表示您同意本隱私政策中描述的做法。 "),t("p",null,"最後更新日期：2023年12月15日")],-1),R=["id"],j=["innerHTML"],q=m('<div class="contact-info"><h2>聯絡我們</h2><p>如果您對本隱私政策有任何疑問或需要行使您的權利，請透過以下方式聯絡我們：</p><ul><li><strong>電子郵件：</strong> privacy@shibahotel.com</li><li><strong>電話：</strong> (02) 2345-6789</li><li><strong>地址：</strong> 台北市信義區松高路123號</li></ul><p> 我們承諾在收到您的請求後30天內回覆。如果您對我們處理您請求的方式不滿意，您有權向當地資料保護機構提出投訴。 </p></div>',1),Y={__name:"PrivacyView",setup(D){const n=p([]),e=p([{title:"我們收集的資料",content:`
    ...
    `}]),d=g=>{const r=parseInt(g.split("-")[1]);if(n.value[r]){const o=n.value[r].getBoundingClientRect().top+window.pageYOffset+-100;window.scrollTo({top:o,behavior:"smooth"})}};return v(()=>{n.value=new Array(e.value.length).fill(null)}),(g,r)=>{const a=k("router-link");return l(),s("div",T,[t("section",B,[t("div",V,[b,t("div",I,[C(a,{to:"/"},{default:f(()=>[y("首頁")]),_:1}),M,N])])]),t("section",S,[t("div",$,[t("div",x,[t("div",H,[t("div",L,[O,t("ul",null,[(l(!0),s(u,null,_(e.value,(i,o)=>(l(),s("li",{key:o},[t("a",{href:`#section-${o}`,onClick:w(c=>d(`section-${o}`),["prevent"])},h(i.title),9,A)]))),128))])])]),t("div",F,[P,(l(!0),s(u,null,_(e.value,(i,o)=>(l(),s("div",{key:o,id:`section-${o}`,ref_for:!0,ref:c=>{c&&(n.value[o]=c)},class:"policy-section"},[t("h2",null,h(i.title),1),t("div",{innerHTML:i.content},null,8,j)],8,R))),128)),q])])])])])}}};export{Y as default};
